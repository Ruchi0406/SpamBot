#Devansh + Code from PyXen 
import asyncio

from DevXSPam.data import GROUP, PORMS
    ...
    if event.sender_id in SUDO_USERS:
        ...
        try:
            if len(altron) == 3:
                ...
                await event.reply(f"🥂 **Usage:**\n  » {hl}spam 39 𝐑ᴀᴅɪᴜx-𝐒ᴘᴀᴍ\n  » {hl}spam 39 <ʀᴇᴘʟʏ ᴛᴏ ᴛᴇxᴛ>\n\n**To do spam with replying to a user:**\n  » {hl}spam 39 𝐑ᴀᴅɪᴜx-𝐒ᴘᴀᴍ <ʀᴇᴘʟʏ ᴛᴏ ᴜꜱᴇʀ>")
...
async def pspam(event):
    if event.sender_id in SUDO_USERS:
        if event.chat_id in GROUP:
            await event.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ 𝐑ᴀᴅɪᴜx-𝐒ᴘᴀᴍ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.")
        else:
            try:
...
async def hang(e):
    if e.sender_id in SUDO_USERS:
        if e.chat_id in GROUP:
            await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ 𝐑ᴀᴅɪᴜx-𝐒ᴘᴀᴍ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.")
        else:
            try:
