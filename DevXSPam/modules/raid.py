...
from DEvXSPam.data import RAID, REPLYRAID, ALTRON, MRAID, SRAID, CRAID, ALTRON
...
async def raid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in ALTRON:
                await e.reply("ʏᴏᴜ ʙʟᴏᴏᴅʏ ғᴜ*ᴋᴇʀ,  ᴛʜᴀᴛ ɢᴜʏ ɪs ʏᴏᴜʀ ғᴀᴛʜᴇʀ.")
            elif uid == OWNER_ID:
                await e.reply("ʏᴏᴜ ʙʟᴏᴏᴅʏ ғᴜ*ᴋᴇʀ,  ᴛʜᴀᴛ ɢᴜʏ ɪs ʏᴏᴜʀ ғᴀᴛʜᴇʀ.")
            elif uid in SUDO_USERS:
                await e.reply("ᴡᴛғ, ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ʀᴀɪᴅ ᴏɴ ᴍʏ ᴍᴀsᴛᴇʀ's ғʀɪᴇɴᴅ.")
            else:
...
async def craid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply(f"𝐌ᴏᴅᴜʟᴇ Nᴀᴍᴇ : C𝐑ᴀɪᴅ\n  » {hl}raid <ᴄᴏᴜɴᴛ> <ᴜꜱᴇʀɴᴀᴍᴇ ᴏꜰ ᴜꜱᴇʀ>\n  » {hl}raid <ᴄᴏᴜɴᴛ> <ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜꜱᴇʀ>")
        except Exception as e:
            print(e)
